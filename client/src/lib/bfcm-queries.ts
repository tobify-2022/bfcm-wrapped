...
export function getShopifyBFCMStatsQuery(
  ...
  // Always return the official BFCM 2025 platform stats query description
  return `Official BFCM 2025 Platform Stats (Always Displayed):
...
These are official Shopify platform-wide statistics for BFCM 2025, always displayed in every report.`;
}
...
export async function getShopifyBFCMStats(
  ...
  // Always return official BFCM 2025 platform stats regardless of selected dates
  // These amazing stats should be celebrated in every report!
  return {
